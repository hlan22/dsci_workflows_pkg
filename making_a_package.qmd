...
Don't be dismayed by the warning about `"Objects listed as exports, but not present in namespace: function-name"`. That always happens when you remove something from the namespace.
